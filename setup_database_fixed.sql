...
drop policy if exists "garments_select_owner" on public.garments;
drop policy if exists "garments_insert_owner" on public.garments;
drop policy if exists "garments_update_owner" on public.garments;
